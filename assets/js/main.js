...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (discountSliderWrapper) {
    ...
    discountItems.forEach((item) => {
      ...
      discountSlidesHTML += `
        <div class="swiper-slide">
          <a href="#" class="dg-item relative block">
            <img
              src="${item.image}"
            ...
            >
              <span class="w-9 h-9 flex rounded-full bg-black/10">
                <img
  ...
  if (topRatedSliderWrapper) {
    ...
    topRatedItems.forEach((item) => {
      ...
      topRatedSlidesHTML += `
        <div class="swiper-slide">
          <a href="#" class="fd-item relative block w-full">
            <img
              src="${item.image}"
              class="aspect-[16/10] rounded-2xl object-cover w-full"
            />
  ...
  if (localFavoritesSliderWrapper) {
    ...
    localFavorites.forEach((item) => {
      ...
      localFavoritesHTML += `
          <div class="swiper-slide">
            <a href="#" class="fd-item relative block">
              <img
                src="${item.image}"
